...
describe('NgssmCachedItemSetter', () => {
  ...
  it(`should update the status of a data source`, () => {
    TestBed.inject(NgssmCachedItemSetter).setCacheItemStatus(key, CachedItemStatus.loading);
  ...
  it(`should update the value of a data source`, () => {
    TestBed.inject(NgssmCachedItemSetter).setCacheItemValue(key, { label: 'testing update' });
